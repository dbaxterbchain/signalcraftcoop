# MUI Theme Implementation (Draft)

This file provides a starter theme configuration for MUI based on the Signalcraft Coop UI system.
The implemented theme lives at `web/src/theme.ts`.
...
Notes
- Add custom shadows as needed in your design system.
- Consider using CSS variables for gradients in global styles.
